...
def normalize_operational(row: Dict[str, str], source_fallback: str, idx: int) -> Dict[str, object] | None:
    # CORREÇÃO: a coluna que continha esse marcador foi renomeada de "Tipo Registro"
    # para "Tipo de Serviço" na planilha (era idêntica à coluna Rota e por isso nunca
    # alimentava o indicador "Serviço por Tipo de Serviço"). Mantemos "Tipo Registro"
    # na lista por retrocompatibilidade com bases antigas que ainda usem esse nome.
    tipo_reg = pick(row, "Tipo Registro", "Tipo de Serviço", "Tipo Serviço", default="Operacional").lower()
